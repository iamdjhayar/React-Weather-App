                    ...
                    <div className="mt-2 flex justify-center items-center">
                        <div style={{
                            ...
                            <ReactSpeedometer
                                ...
                                segmentColors={["#F6BDC0", "#F1959B", "#F07470", "#EA4C46", "#DC1C13"]}
                            />
                        </div>
                    </div>
                </div>
                <div className="w-4/12 bg-white rounded-md shadow-sm p-3 m-5">
                    ...
                    <div className="flex flex-col justify-center items-center h-full mb-2">
                        <div className="font-bold text-4xl text-center text-red-500">
                            {props.data.wind_speed}<span className="text-base">km/h</span>
                        </div>
                        <div>
                            <span className="text-xs">Wind Gust: {props.data.wind_gust}km/h</span>
                        </div>
                        <div className="text-xl text-center mt-2 flex flex-row">
                            <LocationMarkerIcon className="h-8 w-8 text-red-500 mr-3"/>{windDirection}
                        </div>
                    </div>
                </div>
                <div className="w-4/12 bg-white rounded-md shadow-sm p-3 m-5">
